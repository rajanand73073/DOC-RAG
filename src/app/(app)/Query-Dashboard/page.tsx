...
//  allows raw HTML like <br> tags
import remarkBreaks from "remark-breaks"; // converts single \n to <br>
    ...
    <div className="min-h-screen bg-linear-to-br from-zinc-950 via-zinc-900 to-black text-white flex items-center justify-center p-6">
      <div className="w-full max-w-4xl space-y-8">
        ...
        {response && (
          ...
          >
            <Card className="bg-zinc-900 border-zinc-800 rounded-2xl">
              <CardContent className="p-6 space-y-3 text-shadow-white">
        ...
        {Output && (
          ...
          >
            <Card className="bg-zinc-900 border-zinc-800 rounded-2xl">
              <CardContent className="p-6 space-y-3 text-zinc-100">
                <h2 className="text-xl font-semibold text-amber-50"> Output</h2>
                <ReactMarkdown
